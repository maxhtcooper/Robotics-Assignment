...
Then, for the bonus I trained the YOLO26n model on an open flower dataset (https://universe.roboflow.com/yue-xing-dvchh/yolov8-flowers-detection/model/2) for 100 epochs to see if the YOLO26n model could detect flowers, as this is not part of its pretrained classes (as seen in pretrained_yolo_flowers.png).